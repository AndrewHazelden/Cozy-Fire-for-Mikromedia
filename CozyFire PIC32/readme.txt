Cozy Fire for Mikromedia PIC32
Version 1.1 - Released Oct 16, 2012

The Cozy Fire example creates an animated fireplace on the Milromedia PIC32 screen. The Cozy Fire example was created to show how the VisualTFT resource collection feature can be used to create animated sprites. The code was written using VisualTFT and MikroC Pro for PIC32.
